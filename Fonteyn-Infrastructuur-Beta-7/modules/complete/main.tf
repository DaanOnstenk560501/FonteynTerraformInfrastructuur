...
locals {
  vm_size_standard = var.environment == "production" ? "Standard_D4s_v3" : "Standard_B2s"
  vm_size_workstation = var.environment == "production" ? "Standard_D2s_v3" : "Standard_B2s" # Smaller for workstation
